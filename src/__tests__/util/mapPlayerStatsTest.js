...
describe("mapPlayerStats", () => {
  describe("when players boxscores need to map to players", () => {
    it("should map correctly map the stats", () => {
      const players = {
        ID8471724: {
          id: 8471724,
    ...
    it("should map mulitple players", () => {
      const players = {
        ID8471724: {
          id: 8471724,
          fullName: "Kris Letang",
